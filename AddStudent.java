...
public class AddStudent extends JFrame implements ActionListener{
    ...
    JLabel labelrollno;
    JDateChooser dcdob;
    JComboBox cbcourse, cbbranch,cbapplied;
    ...
    AddStudent() {
        ...
        lblug.setBounds(400, 300, 200, 30);
        lblug.setFont(new Font("serif", Font.BOLD, 20));
        add(lblug);

        String applied[] = {"Undergraduation","Postgraduation"};
        cbapplied = new JComboBox(applied);
        cbapplied.setBounds(600, 300, 150, 30);
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == submit) {
            ...
            try {
                String query = "insert into student values('"+rollno+"', '"+name+"', '"+fname+"', '"+dob+"', '"+address+"', '"+phone+"', '"+email+"', '"+course+"', '"+branch+"','"+applied+"')";
