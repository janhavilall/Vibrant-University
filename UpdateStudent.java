...
public class UpdateStudent extends JFrame implements ActionListener{
    ...
    UpdateStudent() {
        ...
        JLabel lblapplied = new JLabel("Applied For");
        lblapplied.setBounds(400, 300, 200, 30);
        lblapplied.setFont(new Font("serif", Font.BOLD, 20));
        add(lblapplied);

        JLabel labelapplied = new JLabel();
        labelapplied.setBounds(600, 300, 150, 30);
        labelapplied.setFont(new Font("Tahoma", Font.PLAIN, 18));
        add(labelapplied);
        ...
        try {
            ...
            while(rs.next()) {
                ...
                labelapplied.setText(rs.getString("applied"));
